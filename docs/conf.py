...
project = u'It-se.me'
copyright = u'2014, Benjamin Kampmann'
...
# of the sidebar.
html_logo = "_static/mustache.svg"
...
latex_documents = [
  ('index', 'Itseme.tex', u'It-se.me Documentation',
   u'Benjamin Kampmann', 'manual'),
]
...
man_pages = [
    ('index', 'itseme', u'It-se.me Documentation',
     [u'Benjamin Kampmann'], 1)
]
